...
<h1 className="text-3xl font-extrabold text-gray-800 dark:text-white show-first">تهانينا! </h1>
<h2 className="text-2xl font-bold text-gray-700 dark:text-gray-300 showInTwoSecond">
  لقد قمت بالتسجيل بنجاح
</h2>
        {/* Tagline */}
        <p className="text-base font-medium text-gray-600 dark:text-white  leading-relaxed px-2 show-third">
إضغط علي زر التالي لبدء رحلتك 
        </p>
