...
const BreakPage: React.FC<BreakPageProps> = ({ heading, text, SvgComponent }) => {
  return (
    <div className="relative w-full h-[70vh] overflow-hidden rounded-[60px] shadow-xl show-fast">
      <div className="absolute inset-0 bg-gradient-to-br from-green-500 to-teal-400 rounded-4xl" />
        <SvgComponent className="absolute top-20 w-3/4 h-1/2 text-emerald-300 dark:text-emerald-950/50  show-third" />
