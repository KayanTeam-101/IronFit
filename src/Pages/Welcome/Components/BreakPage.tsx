...
const BreakPage: React.FC<BreakPageProps> = ({ heading, text, SvgComponent }) => {
  return (
    <div className="relative w-full h-[70vh] overflow-hidden rounded-[60px] show-fast">
      <div className="absolute inset-0 bg-gradient-to-br from-teal-400 to-blue-500 rounded-4xl" />
        <SvgComponent className="absolute top-20 w-3/4 h-1/2 text-blue-100 dark:text-blue-200 opacity-60  " />
