...
const Table = () => {
  ...
  return (
    <div className={`${localStorage.getItem("Diet") ? "" : "opacity-10"} ${localStorage.getItem("hasCongratulatedDiet") && !localStorage.getItem("openXpBefore") ? "opacity-20" : ""} relative flex flex-col w-full min-h-14 p-2   rounded-2xl border-amber-50`}>
