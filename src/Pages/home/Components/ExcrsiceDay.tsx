...
<div className='relative w-full h-full'>
    <h1 className='text-5xl text-white text-shadow-lg font-bold mb-2 leading-14'>اليوم القادم <span className='text-white/60'>{SetNextDay()}</span> <div><GiShoulderArmor className='absolute text-9xl scale-200 left-0 top-0 opacity-20'/></div></h1>
