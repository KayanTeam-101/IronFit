...
const ExerciseDay: React.FC = () => {
  ...
  if (todayWorkout) {
    return (
      <div className="relative min-h-60 w-full p-5 bg-gradient-to-br from-sky-500 to-blue-600  overflow-hidden rounded-3xl border border-sky-50 dark:border-gray-600/20 flex flex-col justify-between shadow-xl transition-all hover:shadow-2xl">
  ...
  if (nextTrainingDay) {
    return (
      <div className="relative min-h-60 w-full p-5 bg-gradient-to-b from-amber-500 to-orange-500  overflow-hidden rounded-3xl border border-amber-50 dark:border-gray-600/20 flex flex-col justify-between shadow-xl transition-all hover:shadow-2xl">
