  ...
  return (
    <div className="relative min-h-screen w-screen  overflow-hidden p-4 flex flex-col gap-5 show-first">
      ...
      <div className="w-full flex flex-row justify-between">
          ...
          <div className={`}text-2xl flex flex-row items-center  gap-2.5 ${localStorage.getItem("Diet") ? "" : "opacity-40"}`}>
...
<div className="flex flex-col">
     ...
     {showTasks && <TasksPanel   showTasks={showTasks}
        ...
        setShowRank={setShowRanking} onClose={() => setShowTasks(false)} />}
          ...
          <div className="flex flex-row gap-3">
                <div className={` ${localStorage.getItem("Diet") ? "" : "opacity-40"} rounded-3xl bg-white dark:bg-[#222]/50 dark:border-2 dark:border-gray-600/20 text-white text-xl font-black tracking-tight flex flex-row  w-1/2 justify-between items-center p-2 shadow-sm`}>
  ...
  onClick={() => setShowTasks(true)}   // ✅ أضف هذا السطر
              className={`relative rounded-3xl  bg-white dark:bg-[#222]/50 dark:border-2 dark:border-gray-600/20 active:scale-85 active:opacity-65 transition delay-75 text-white text-xl font-black tracking-tight flex flex-row  w-1/2 justify-between items-center p-2 shadow-sm ${localStorage.getItem("Diet") ? "" : "opacity-40"}`}>
