...
<>
     ...
     <div
     className="navbar overflow-hidden fixed bottom-0 z-0  grid grid-cols-5 items-center w-full min-h-18 backdrop-blur-[3px]   dark:bg-black/60 border-t  border-gray-200 r text-xl text-gray-800 dark:from-slate-800/40 dark:to-black/40 dark:border-2 dark:border-gray-600/15"
    >
